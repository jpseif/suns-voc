...
class Suns_Voc_Measurement:
    ...
    def __init__(
        ...
        self.localIdeality = self.calc_localIdeality(13)
        self.dsuns = 0.1
    ...
    def ShiftSuns(self, VocLO, SunsLO, SunsDataLO):
        ...
        # Linear regression of LO around the indClosestVoc
    ...
    def MergeData(self, SunsDataListLO, SunsDataListHI, index):
        ...
        localIdeality = self.calc_slope(xData, yData, 13) / (self.const_k * self.TK / self.const_q)
    ...
    def calc_dVdt(self, **kwargs):
        ...
        Output:
            - derivative of the cell voltage with time
                array
        """
        dVdt = self.calc_slope(xData=self.raw['t'], yData=self.raw['volt'], numpts=2)
    ...
    def calc_Voc(self):
        ...
        if fVocSuns.size == 0 or fVoc.size == 0:
            ...
            raise Exception("The Voc could not be determined due to the lack of data close to 1 sun. Check your measurement.")
    ...
    def calc_localIdeality(self, numpts):
        ...
        m = self.calc_slope(xData, yData, numpts) / (self.const_k * self.TK / self.const_q)
